...
Orb.SolarSystem = function(){
  ...
  var vsop_earth =  Orb.Earth; // PlanetLoader("vsop87a_ear.json");
  ...
  return {
    ...
    Sun2:function(){
      var data = Orb.Earth; //PlanetLoader("vsop87a_ear.json");
      return {
        position:{
          equatorial:function(time){
    ...
    FromKeplerian:function(orbital_elements){
      var orbital_elements = orbital_elements;
      return {
        position:{
          ecliptic:function(time){
